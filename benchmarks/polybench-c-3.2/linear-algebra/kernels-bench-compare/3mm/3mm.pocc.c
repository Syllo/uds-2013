...
#pragma omp parallel for private(c2t1, c1, c2) firstprivate(lb1, ub1)
    for (c1t1 = lb1; c1t1 <= ub1; ++(c1t1)) {
        for (c2t1 = round((-1 + (1 / T1c2))); c2t1 <= round(((_PB_NL * (1 / T1c2)) + ((1 / T1c2) * -1))); ++(c2t1)) {
            for (c1 = max((c1t1 * T1c1), 0); c1 <= min(((c1t1 * T1c1) + (T1c1 + -1)), min((_PB_NI + -1), (_PB_NJ + -1))); c1++) {
...
if ((_PB_NL >= 1)) {
  lb1 = round((-1 + (1 / T1c1)));
  ub1 = round(((_PB_NJ * (1 / T1c1)) + ((1 / T1c1) * -1)));
#pragma omp parallel for private(c2t1, c1, c2) firstprivate(lb1, ub1)
    for (c1t1 = lb1; c1t1 <= ub1; ++(c1t1)) {
        for (c2t1 = round((-1 + (1 / T1c2))); c2t1 <= round(((_PB_NL * (1 / T1c2)) + ((1 / T1c2) * -1))); ++(c2t1)) {
            for (c1 = max((c1t1 * T1c1), max(0, _PB_NI)); c1 <= min(((c1t1 * T1c1) + (T1c1 + -1)), (_PB_NJ + -1)); c1++) {
                for (c2 = max((c2t1 * T1c2), 0); c2 <= min(((c2t1 * T1c2) + (T1c2 + -1)), (_PB_NL + -1)); c2++) {
          F[c1][c2]=0;
        }
      }
...
#pragma omp parallel for private(c2t1, c1, c2) firstprivate(lb1, ub1)
    for (c1t1 = lb1; c1t1 <= ub1; ++(c1t1)) {
        for (c2t1 = round((-1 + (1 / T1c2))); c2t1 <= round(((_PB_NL * (1 / T1c2)) + ((1 / T1c2) * -1))); ++(c2t1)) {
            for (c1 = max((c1t1 * T1c1), max(0, _PB_NJ)); c1 <= min(((c1t1 * T1c1) + (T1c1 + -1)), (_PB_NI + -1)); c1++) {
                for (c2 = max((c2t1 * T1c2), 0); c2 <= min(((c2t1 * T1c2) + (T1c2 + -1)), (_PB_NL + -1)); c2++) {
          G[c1][c2]=0;
        }
      }
...
#pragma omp parallel for private(c2t1, c5t1, c1, c2, c5) firstprivate(lb1, ub1)
    for (c1t1 = lb1; c1t1 <= ub1; ++(c1t1)) {
        for (c2t1 = round((-1 + (1 / T1c2))); c2t1 <= round(((_PB_NL * (1 / T1c2)) + ((1 / T1c2) * -1))); ++(c2t1)) {
            for (c5t1 = round((-1 + (1 / T1c5))); c5t1 <= round(((_PB_NM * (1 / T1c5)) + ((1 / T1c5) * -1))); ++(c5t1)) {
                for (c1 = max((c1t1 * T1c1), 0); c1 <= min(((c1t1 * T1c1) + (T1c1 + -1)), (_PB_NJ + -1)); c1++) {
                    for (c2 = max((c2t1 * T1c2), 0); c2 <= min(((c2t1 * T1c2) + (T1c2 + -1)), (_PB_NL + -1)); c2++) {
                        for (c5 = max((c5t1 * T1c5), 0); c5 <= min(((c5t1 * T1c5) + (T1c5 + -1)), (_PB_NM + -1)); c5++) {
