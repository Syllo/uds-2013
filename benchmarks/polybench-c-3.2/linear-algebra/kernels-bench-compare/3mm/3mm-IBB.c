...
DATA_TYPE POLYBENCH_2D(G,NI,NL,ni,nl))
{
  ...
  if (_PB_NI >= 1) {
    for (_mfr_ref1=0;_mfr_ref1<=_PB_NI-1;_mfr_ref1++) {    
      i1=0;
      j1=_mfr_ref1;
      E[i1][j1]=0;
      i2=0;
      j2=_mfr_ref1;
      F[j2][i2]=0;
      for (_mfr_ref2=0;_mfr_ref2<=_PB_NI-1;_mfr_ref2++) {    
        i1=0;
        j1=_mfr_ref1;
        k1=_mfr_ref2;
    ...
    for (_mfr_ref0=1;_mfr_ref0<=_PB_NI-1;_mfr_ref0++) {    
      i4=_mfr_ref0-1;
      calculatation(i4,_PB_NI,G,E,F,1);
      for (_mfr_ref1=0;_mfr_ref1<=_PB_NI-1;_mfr_ref1++) {    
        i1=_mfr_ref0;
        j1=_mfr_ref1;
        E[i1][j1]=0;
    ...
    i4=_mfr_ref0-1;
    calculatation(i4,_PB_NI,G,E,F,1);
    for (_mfr_ref0=_PB_NI+1;_mfr_ref0<=2*_PB_NI-1;_mfr_ref0++) {    
      i3=_mfr_ref0-_PB_NI;
      calculatation(i3,_PB_NI,G,E,F,0);
    }
  }
